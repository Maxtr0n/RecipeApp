...
public static class Constants
{
    ...
    public static readonly List<Ingredient> RecipeIngredients =
    [
        new("Ingredient1", new Quantity(5.0, "liter"))
    ];


    public static readonly List<IngredientCreateDto> RecipeIngredientDtos =
    [
